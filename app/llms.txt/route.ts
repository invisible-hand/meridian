...
- [The build map](${abs("/agentic-banking/build")}): A vendor-neutral design tool for AI systems inside a bank — ten questions produce a brief with pattern, controls, applicable documents, evals, human gates and examiner questions; twelve standard briefs by use case
