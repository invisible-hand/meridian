...
export const DOCUMENTS: RegDocument[] = [
  ...
  },
  {
    ...
    "deepDives": [
      {
        "id": "what-does-part-500-require",
        "label": "Part 500 explained",
        "question": "What does 23 NYCRR Part 500 require, who does it apply to, and what are the deadlines?",
        "answer": "23 NYCRR Part 500 is the New York Department of Financial Services cybersecurity regulation. It applies to every 'covered entity' — any person operating under, or required to operate under, a DFS license, registration, charter, certificate, permit, accreditation or similar authorization under the Banking Law, Insurance Law or Financial Services Law, which includes New York-chartered banks, DFS-licensed branches and agencies of foreign banks, insurers, mortgage lenders and money transmitters. It requires a written cybersecurity program built on a risk assessment that is updated at least annually, a chief information security officer who reports to the board, multi-factor authentication for anyone accessing the entity's information systems, notice to the Superintendent within 72 hours of a cybersecurity incident and within 24 hours of any extortion payment, and an annual certification of material compliance filed by April 15. The Second Amendment took effect November 1, 2023 and its last provisions — universal MFA and asset inventories — became mandatory on November 1, 2025, so every requirement is now in force.",
        "requirements": [
          { "rule": "§500.2 — Cybersecurity program", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "A written program based on the §500.9 risk assessment, designed to identify, protect against, detect, respond to and recover from cybersecurity events; Class A companies must also have it independently audited annually.", "when": "In force" },
          { "rule": "§500.3 — Cybersecurity policy", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Written policies and procedures approved at least annually by the senior governing body or a senior officer, covering the listed areas from data governance to vendor management.", "when": "In force" },
          { "rule": "§500.4 — CISO and senior governing body", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "A qualified CISO with adequate authority who reports in writing to the board at least annually; the board must have sufficient understanding of cybersecurity to exercise oversight.", "when": "Since Nov 1, 2024" },
          { "rule": "§500.5 — Vulnerability management", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Annual penetration testing from inside and outside the network, automated scans plus manual review where scans cannot reach, and timely remediation prioritised by risk.", "when": "Since May 1, 2025" },
          { "rule": "§500.7 — Access privileges", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Least-privilege access, privileged accounts limited and reviewed at least annually, prompt removal of unneeded access; Class A companies need privileged access management and automated blocking of common passwords.", "when": "Since May 1, 2025" },
          { "rule": "§500.9 — Risk assessment", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "A documented risk assessment, reviewed and updated at least annually and whenever a change in business or technology materially affects cyber risk — the hook DFS uses to require AI-specific threats to be assessed.", "when": "In force" },
          { "rule": "§500.11 — Third-party service providers", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Written policies for identifying, assessing and contractually binding third parties that access systems or nonpublic information, with periodic reassessment.", "when": "In force" },
          { "rule": "§500.12 — Multi-factor authentication", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "MFA for any individual accessing any information system of the covered entity; limited-exemption entities need it for remote access, privileged accounts and third-party application access.", "when": "Since Nov 1, 2025" },
          { "rule": "§500.13 — Asset inventory and data retention", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "A complete, accurate inventory of information systems with owner, location, classification, support expiration and recovery objectives, plus policies for disposing of nonpublic information no longer needed.", "when": "Since Nov 1, 2025" },
          { "rule": "§500.14 — Monitoring and training", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Risk-based monitoring of user activity, protection against malicious code, and at least annual cybersecurity awareness training that includes social engineering; Class A companies add endpoint detection and response and centralised logging.", "when": "Since May 1, 2025" },
          { "rule": "§500.15 — Encryption", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Encryption of nonpublic information in transit over external networks and at rest, with compensating controls for at-rest data only where encryption is infeasible and the CISO approves them.", "when": "Since Nov 1, 2024" },
          { "rule": "§500.16 — Incident response and business continuity", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Written incident response and business continuity and disaster recovery plans, tested at least annually, with backups isolated from network connections.", "when": "Since Nov 1, 2024" },
          { "rule": "§500.17 — Notices and annual certification", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Notice to the Superintendent within 72 hours of a cybersecurity incident (including at affiliates and third-party providers), within 24 hours of an extortion payment and a written explanation within 30 days; by April 15 each year, a certification of material compliance or an acknowledgment of non-compliance with a remediation plan, signed by the highest-ranking executive and the CISO.", "when": "Since Dec 1, 2023" },
          { "rule": "§500.19 — Limited exemptions", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "Reduced obligations for entities with fewer than 20 employees and independent contractors, less than $7.5 million in gross annual revenue from New York operations in each of the last three fiscal years, or less than $15 million in year-end total assets — still subject to the program, policy, access, risk assessment, third-party, MFA, retention, training, incident response and notice requirements.", "when": "In force" },
          { "rule": "Class A company (§500.1(d))", "authority": "ny-dfs", "docSlug": "ny-dfs-23-nycrr-part-500", "requirement": "A covered entity with at least $20 million in gross annual revenue in each of the last two fiscal years from New York operations (including affiliates' New York operations) and either more than 2,000 employees averaged over the last two fiscal years or more than $1 billion in gross annual revenue from all operations, worldwide, including affiliates.", "when": "In force" },
          { "rule": "DFS industry letter on AI cybersecurity risks", "authority": "ny-dfs", "docSlug": "ny-dfs-industry-letter-2024-10-16-ai-cyber-risks", "requirement": "DFS's October 16, 2024 letter maps AI-enabled threats (deepfake social engineering, AI-enhanced attacks, exposure of nonpublic information, vendor AI) onto existing Part 500 sections — risk assessments, third-party policies, MFA, monitoring and training — rather than adding new rules.", "when": "Oct 2024" },
          { "rule": "DFS industry letter on frontier AI models", "authority": "ny-dfs", "docSlug": "ny-dfs-industry-letter-2026-05-21-frontier-ai-models", "requirement": "May 21, 2026 guidance on the cyber risks from frontier AI models, again framed as Part 500 obligations.", "when": "May 2026" }
        ],
        "detail": [
  ...
  },
  {
    ...
    "deepDives": [
      {
        "id": "nist-ai-rmf-1-0-pdf",
        "label": "The official documents",
        "question": "Where is the official NIST AI RMF 1.0 PDF, and what does the framework contain?",
        "answer": "The official NIST AI Risk Management Framework 1.0 is document NIST AI 100-1, published January 26, 2023, and the PDF is hosted by NIST at nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf (DOI 10.6028/NIST.AI.100-1). It has two parts. Part 1 frames AI risk — how it differs from traditional software risk, who the intended audience is, and the seven characteristics of trustworthy AI: valid and reliable, safe, secure and resilient, accountable and transparent, explainable and interpretable, privacy-enhanced, and fair with harmful bias managed. Part 2 is the Core: four functions — Govern, Map, Measure and Manage — each broken into categories and subcategories of outcomes that an organization tailors into a 'profile' for its own context. The framework is voluntary. Its companions are the online AI RMF Playbook, a Roadmap, crosswalks to other standards, and the Generative AI Profile (NIST AI 600-1, July 26, 2024), also a NIST-hosted PDF. NIST states that AI RMF 1.0 is being revised under the July 2025 White House AI Action Plan; no revised draft has been published.",
        "requirements": [
          { "rule": "NIST AI 100-1 — AI RMF 1.0 (official PDF)", "authority": "nist", "link": "https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf", "requirement": "The framework document itself, January 26, 2023: Part 1 (framing risk, audience, trustworthiness characteristics) and Part 2 (the Core: Govern, Map, Measure, Manage) plus appendices on AI risk versus traditional software risk and on attributes of the framework.", "when": "Published Jan 26, 2023" },
          { "rule": "AI RMF landing page", "authority": "nist", "docSlug": "nist-ai-100-1", "requirement": "NIST's page for the framework, with the PDF, the Playbook, Roadmap, crosswalks, profiles and the notice that AI RMF 1.0 is being revised as part of the White House AI Action Plan.", "when": "Maintained" },
          { "rule": "AI RMF Playbook", "authority": "nist", "link": "https://airc.nist.gov/airmf-resources/playbook/", "requirement": "Suggested actions, references and documentation guidance for every subcategory of the Core, hosted at the NIST AI Resource Center; NIST will update it after the framework revision.", "when": "Online" },
          { "rule": "NIST AI 600-1 — Generative AI Profile (official PDF)", "authority": "nist", "docSlug": "nist-ai-600-1", "requirement": "The July 26, 2024 profile of the AI RMF for generative AI: twelve risk categories unique to or exacerbated by generative systems, with suggested actions mapped to the Core.", "when": "Published Jul 26, 2024" },
          { "rule": "NIST AI 100-2 E2025 — Adversarial machine learning taxonomy", "authority": "nist", "docSlug": "nist-ai-100-2e2025", "requirement": "NIST's companion taxonomy of attacks on predictive and generative AI and their mitigations — the reference for the 'secure and resilient' characteristic.", "when": "Published Mar 2025" },
          { "rule": "Concept note — AI RMF profile for critical infrastructure", "authority": "nist", "docSlug": "nist-ai-rmf-critical-infrastructure-profile-concept-note", "requirement": "April 7, 2026 concept note for a sector profile covering critical infrastructure, which includes the financial services sector.", "when": "Apr 2026" }
        ],
        "detail": [
  ...
  },
  {
    ...
    "deepDives": [
      {
        "id": "ss1-23-explained",
        "label": "SS1/23 explained",
        "question": "What does PRA SS1/23 require, and how do its model risk management principles apply to AI and machine-learning models?",
        "answer": "Supervisory Statement 1/23, 'Model risk management principles for banks', is the Prudential Regulation Authority's model risk management standard. Published with Policy Statement 6/23 on 17 May 2023, in force since 17 May 2024 and amended on 23 April 2026, it sets five principles: model identification and model risk classification; governance; model development, implementation and use; independent model validation; and model risk mitigants. Its formal scope is UK-incorporated banks, building societies and PRA-designated investment firms with internal-model permissions for credit, market or counterparty credit risk, but the PRA expects every firm to apply it proportionately. The model definition covers all models that inform business decisions regardless of technology, including vendor models and models used for financial reporting, and a sub-principle requires firms to identify and manage the risks that arise from artificial intelligence and machine-learning techniques. Accountability for the whole MRM framework must be allocated to a named Senior Management Function holder.",
        "requirements": [
          { "rule": "Principle 1 — Model identification and model risk classification", "authority": "uk", "docSlug": "pra-ss1-23-model-risk-management", "requirement": "A firm-wide definition of a model, a complete model inventory, and a risk-based tiering of every model by materiality and complexity that drives the intensity of every other principle.", "when": "Since 17 May 2024" },
          { "rule": "Principle 2 — Governance", "authority": "uk", "docSlug": "pra-ss1-23-model-risk-management", "requirement": "Board-approved MRM policy and risk appetite, responsibility for the overall framework allocated to the most appropriate SMF holder, and reporting on the effectiveness of MRM for financial reporting to the audit committee.", "when": "Since 17 May 2024" },
          { "rule": "Principle 3 — Model development, implementation and use", "authority": "uk", "docSlug": "pra-ss1-23-model-risk-management", "requirement": "Documented development standards, data quality and suitability assessments, testing, controls over implementation and use, and management of the specific risks of AI and machine-learning techniques as they apply to models generally.", "when": "Since 17 May 2024" },
          { "rule": "Principle 4 — Independent model validation", "authority": "uk", "docSlug": "pra-ss1-23-model-risk-management", "requirement": "Validation independent of development, proportionate to tier, before use and periodically thereafter, with ongoing monitoring, effective challenge and findings tracked to closure; vendor models are validated like in-house ones.", "when": "Since 17 May 2024" },
          { "rule": "Principle 5 — Model risk mitigants", "authority": "uk", "docSlug": "pra-ss1-23-model-risk-management", "requirement": "Governed post-model adjustments and overlays, restrictions on use, escalation and exception processes, and the ability to fall back when a model is found deficient.", "when": "Since 17 May 2024" },
          { "rule": "LIAF01/26 — amendment to SS1/23", "authority": "uk", "link": "https://www.bankofengland.co.uk/prudential-regulation/publication/2026/april/low-impact-amendments-finalisation-april-2026", "requirement": "Clarifies that SS1/23 expectations are not conditions for internal model approval; a firm that first receives an internal-model permission has 12 months from the grant to comply. Internal-model firms now assess stress-test models against SS1/23 rather than SS3/18 alone.", "when": "From 23 Apr 2026" },
          { "rule": "PRA AI/ML model-risk roundtable (Oct 2025)", "authority": "uk", "docSlug": "pra-mrm-roundtable-ai-ml-2025", "requirement": "The PRA's current thinking, from two CRO roundtables with 21 firms on 20 and 22 October 2025, on applying SS1/23 to AI and ML: risk appetite, model tiering, explainability, overfitting, validation and monitoring.", "when": "Nov 2025" },
          { "rule": "Bank of England AI roundtables (summary, Feb 2026)", "authority": "uk", "link": "https://www.bankofengland.co.uk/minutes/2026/february/summary-of-ai-roundtables-feb-2026", "requirement": "Three sector roundtables in late 2025, published 16 February 2026: firms called SS1/23 'pragmatic in enabling responsible AI adoption', asked for no AI-specific rules, and said traditional validation 'wouldn't be sustainable' for generative and agentic systems.", "when": "Feb 2026" }
        ],
        "detail": [
  ...
  },
  {
    ...
    "deepDives": [
      {
        "id": "what-is-bcbs-239",
        "label": "BCBS 239 explained",
        "question": "What is BCBS 239 and what are its 14 principles?",
        "answer": "BCBS 239 is the Basel Committee on Banking Supervision's January 2013 paper 'Principles for effective risk data aggregation and risk reporting' — the 239th Basel Committee publication, which is where the number comes from. It sets 14 principles in four groups: overarching governance and infrastructure (Principles 1–2), risk data aggregation capabilities (3–6), risk reporting practices (7–11), and supervisory review, tools and cooperation (12–14). It is not a regulation but a supervisory expectation: global systemically important banks had to meet it by the beginning of 2016, national supervisors are 'strongly suggested' to apply it to domestic systemically important banks three years after their designation, and supervisors enforce it through Pillar 2 measures. The official text is a 28-page PDF on bis.org, linked in the table below.",
        "requirements": [
          { "rule": "Official text (PDF)", "authority": "basel-committee", "link": "https://www.bis.org/publ/bcbs239.pdf", "requirement": "Principles for effective risk data aggregation and risk reporting, Basel Committee on Banking Supervision, 9 January 2013 — the primary source for everything below.", "when": "Published Jan 2013" },
          { "rule": "Principle 1 — Governance", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Risk data aggregation and risk reporting must sit under strong governance arrangements consistent with the Committee's other principles; the board and senior management own them.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 2 — Data architecture and IT infrastructure", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Design, build and maintain data architecture and IT infrastructure that fully supports aggregation and reporting in normal times and in stress or crisis.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 3 — Accuracy and integrity", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Generate accurate and reliable risk data; aggregate on a largely automated basis to minimise the probability of errors.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 4 — Completeness", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Capture and aggregate all material risk data across the group, available by business line, legal entity, asset type, industry, region and other relevant groupings.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 5 — Timeliness", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Generate aggregate, up-to-date risk data in a timely manner, with timing set by the volatility and criticality of the risk and by normal and stress reporting needs.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 6 — Adaptability", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Meet a broad range of on-demand, ad hoc reporting requests, including in stress, for changing internal needs and for supervisory queries.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 7 — Accuracy (reporting)", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Risk reports must accurately and precisely convey aggregated data and be reconciled and validated.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 8 — Comprehensiveness", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Reports cover all material risk areas, with depth and scope matching the bank's size, complexity and risk profile and the recipients' requirements.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 9 — Clarity and usefulness", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Reports communicate clearly and concisely, balancing data, analysis, interpretation and qualitative explanation, tailored to the recipients.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 10 — Frequency", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "The board and senior management set report frequency to reflect recipients' needs and how fast the risk can change; frequency increases in stress or crisis.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 11 — Distribution", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Reports reach the relevant parties while confidentiality is maintained.", "when": "G-SIBs from 2016" },
          { "rule": "Principle 12 — Review", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Supervisors periodically review and evaluate a bank's compliance with Principles 1–11.", "when": "Supervisors" },
          { "rule": "Principle 13 — Remedial actions and supervisory measures", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Supervisors have and use tools — including Pillar 2 — to require effective and timely remediation of deficiencies.", "when": "Supervisors" },
          { "rule": "Principle 14 — Home/host cooperation", "authority": "basel-committee", "docSlug": "bcbs-239", "requirement": "Home and host supervisors cooperate on the review of the principles and on any remedial action.", "when": "Supervisors" },
          { "rule": "Basel Committee newsletter on BCBS 239 implementation", "authority": "basel-committee", "docSlug": "bcbs-newsletter-bcbs239-implementation-2026", "requirement": "January 2026 assessment: data-driven culture, data lineage and ad hoc reporting remain 'a work in progress'; AI and advanced automation depend on the same high-quality data.", "when": "Jan 2026" }
        ],
        "detail": [
