...
- executiveSummary: three to five sentences, 70 to 120 words, of facts from the source text that support the take. State the event in sentence one (who did what), then the details a reader needs to judge it: how it works, the scale (customers, volumes, dollar amounts, percentages), who is affected and how, the timeline, and what the actor says comes next. Every sentence adds a new fact. Cut announcement dates, headcounts, office openings, community grants, secondary quotes, background surveys and industry statistics.
